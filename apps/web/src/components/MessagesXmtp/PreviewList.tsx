import Preview from '@components/MessagesXmtp/Preview';
...
import type { TabValues } from 'src/store/messages';
import { useMessagePersistStore, useMessageStore } from 'src/store/messages';
