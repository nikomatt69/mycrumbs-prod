...
const getNftOpenActionKit = () => {
  return new NftOpenActionKit({
    decentApiKey: process.env.NEXT_PUBLIC_DECENT_API_KEY as string || '4d019b3d2209196b20dd207f8c19c8a9',
    openSeaApiKey: process.env.NEXT_PUBLIC_OPENSEA_API_KEY as string || '',
    raribleApiKey: process.env.NEXT_PUBLIC_RARIBLE_API_KEY as string || ''
  });
};
